...
Compared methods & Clean reference: No Attack + Mean; attacked defenses: NormClipping, MultiKrum, FLTrust, FLDetector, CARAT & Rows in Table~\ref{tab:cifar-main-acc}. \\
...
Reported statistic & Final-round accuracy, mean $\pm$ sample standard deviation & Bold values identify the strongest attacked defense per attack; the clean reference is excluded. \\
\bottomrule
\end{tabular}
}
\end{table*}
